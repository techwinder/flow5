...
LineStyle Section2dWt::s_HighStyle   = {true, Line::SOLID, 5, Qt::blue, Line::NOSYMBOL};
LineStyle Section2dWt::s_SelectStyle = {true, Line::SOLID, 5, Qt::red,  Line::NOSYMBOL};
