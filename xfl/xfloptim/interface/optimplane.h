...
class OptimPlane : public QDialog
{
    Q_OBJECT
    public:
        OptimPlane(QWidget *pParent);
        ~OptimPlane();
    ...
    private:
        ...
        bool readObjectives();
        bool runPlaneAnalysis(PlaneXfl *pPlaneXfl, WPolar *pWPolar, QVector<double> const &opplist);
    ...
    protected:
        ...
        QVector<OptVariable>  m_OptVariable;
        ...
        static QByteArray s_HSplitterSizes, s_LeftVSplitterSizes, s_RightVSplitterSizes;

        static double s_AlphaMin, s_AlphaMax;
