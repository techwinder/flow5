...
class XflScriptReader : public QXmlStreamReader
{
    ...
    public:
        ...
        double foilAlphaMin()   const {return m_FoilAlphaMin;}
        double foilAlphaMax()   const {return m_FoilAlphaMax;}
        double foilAlphaInc()   const {return m_FoilAlphaInc;}
    ...
    private:
        ...
        double m_FoilAlphaMin, m_FoilAlphaMax, m_FoilAlphaInc; /** type 123 polars */
        double m_FoilClMin, m_FoilClMax, m_FoilClInc; /** type 123 polars */
        double m_FoilReynoldsMin, m_FoilReynoldsMax, m_FoilReynoldsInc; /** Foil type 4 polars */
        double m_FoilCtrlMin, m_FoilCtrlMax, m_FoilCtrlInc; /** Foil type 6 polars */
