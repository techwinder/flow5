...
bool XmlXSailReader::readNURBSSail(NURBSSail *pNSail, Vector3d &position, double lengthunit, double areaunit)
{
    ...
    while(!atEnd() && !hasError() && readNextStartElement())
    {
        ...
        {
            pNSail->setName(readElementText().trimmed());
        }
        ...
        {
            pNSail->setPartDescription(readElementText().trimmed());
        }
...
bool XmlXSailReader::readSplineSail(SplineSail *pSSail, Vector3d &position, double lengthunit, double areaunit)
{
    ...
    while(!atEnd() && !hasError() && readNextStartElement())
    {
        if (name().toString().compare(QString("name"),Qt::CaseInsensitive) ==0)
        {
            pSSail->setName(readElementText().trimmed());
        }
        else if(name().toString().compare(QString("The_Style"), Qt::CaseInsensitive)==0)
        {
            LineStyle ls;
        ...
        {
            pSSail->setPartDescription(readElementText().trimmed());
        }
        else if (name().compare(QString("Position"), Qt::CaseInsensitive)==0)
        {
            QStringList coordList = readElementText().simplified().split(",");
            ...
            while(!atEnd() && !hasError() && readNextStartElement() )
            {
                ...
                else if (name().compare(QString("point"), Qt::CaseInsensitive)==0)
                {
                    ...
                    if(coordList.length()>=3)
                    {
                        ...
                        ctrlpts.last().push_back({x,y});
                        weights.last().push_back(w);
                    }
                }
...
bool XmlXSailReader::readWingSail(WingSail *pWSail, Vector3d &position, double lengthunit, double areaunit)
{
    ...
    while(!atEnd() && !hasError() && readNextStartElement())
    {
        ...
        if (name().toString().compare(QString("name"),Qt::CaseInsensitive) ==0)
        {
            pWSail->setName(readElementText().trimmed());
        }
        else if(name().toString().compare(QString("The_Style"), Qt::CaseInsensitive)==0)
        {
            LineStyle ls;
        ...
        {
            pWSail->setPartDescription(readElementText().trimmed());
        }
        else if (name().compare(QString("Position"), Qt::CaseInsensitive)==0)
        {
            QStringList coordList = readElementText().simplified().split(",");
