...
void XflXmlWriter::writeColor(QColor const &color)
{
...
void XflXmlWriter::writeWing(WingXfl const &wing, Vector3d WingLE, double Rx, double Ry)
{
    ...
    if(!SaveOptions::bXmlWingFoils()) return;
