...
double potentialP3(const Vector3d &pt, QVector<Panel3> const &panel3, PANELMETHOD Method, bool bSource, double CoreRadius)
{
    double phib[]{0,0,0};
...
double potentialP4(const Vector3d &pt, const QVector<Panel4> &panel4, PANELMETHOD Method, bool bSource, double CoreRadius)
{
    double phi(0), phi_tot(0);
...
Vector3d velocityP3(Vector3d const &pt, QVector<Panel3> const &panel3, PANELMETHOD Method, bool bSource, double CoreRadius, Vortex::enumVortex VortexModel)
{
    Vector3d V, vel, Vb[3];
...
Vector3d velocityP4(Vector3d const &pt, QVector<Panel4> const &panel4, PANELMETHOD Method, bool bSource, double CoreRadius)
{
    Vector3d V, vel, Vb[3];
