...
class Plane : public fl5Object
{
    public:
        Plane();
        virtual ~Plane() = default;

        virtual QString planeData(bool bOtherWings=false) const = 0;
        ...
        virtual bool connectTriMesh(bool bConnectTE, bool bThickSurfaces) = 0;
        ...
        virtual bool checkFoils(QString &) const {return true;}
        ...
        void setPointMasses(QVector<PointMass> const &PointMassList){m_Inertia.setPointMasses(PointMassList);}
        void clearPointMasses() {m_Inertia.clearPointMasses();}
        QVector<PointMass> const &pointMassList() const {return m_Inertia.pointMasses();}
