...
void SaveOptionsWt::initWidget()
{
    ...
    m_pchOpps->setChecked(SaveOptions::bSaveOpps());
    m_pchPOpps->setChecked(SaveOptions::bSavePOpps());
    m_pchBtOpps->setChecked(SaveOptions::bSaveBtOpps());
...
void SaveOptionsWt::readData()
{
    ...
    SaveOptions::s_bSaveOpps     = m_pchOpps->isChecked();
    SaveOptions::s_bSavePOpps    = m_pchPOpps->isChecked();
    SaveOptions::s_bSaveBtOpps   = m_pchBtOpps->isChecked();
