...
LineStyle gl3dAxesView::s_WindVecsStyle{true, Line::SOLID, 2, Qt::darkGray,  Line::NOSYMBOL, "Wind vectors"};

LineStyle gl3dAxesView::s_StabStyle = {true, Line::SOLID, 3, Qt::blue,       Line::NOSYMBOL, "Stability axes"};
LineStyle gl3dAxesView::s_BodyStyle = {true, Line::DASH,  3, Qt::darkCyan,   Line::NOSYMBOL, "Body axes"};
LineStyle gl3dAxesView::s_WindStyle = {true, Line::DOT,   3, Qt::red,        Line::NOSYMBOL, "Wind axes"};
...
void gl3dAxesView::loadSettings(QSettings &settings)
{
    settings.beginGroup("gl3dAxesView");
    {
        ...
        s_WindVecsStyle.loadSettings(settings, "WindVecsStyle");
        s_BodyStyle.loadSettings(settings, "BodyStyle");
        s_WindStyle.loadSettings(settings, "WindStyle");
        s_StabStyle.loadSettings(settings, "StabStyle");
    }
    settings.endGroup();
}
...
void gl3dAxesView::saveSettings(QSettings &settings)
{
    settings.beginGroup("gl3dAxesView");
    {
        ...
        s_WindVecsStyle.saveSettings(settings, "WindVecsStyle");
        s_BodyStyle.saveSettings(settings, "BodyStyle");
        s_WindStyle.saveSettings(settings, "WindStyle");
        s_StabStyle.saveSettings(settings, "StabStyle");
    }
    settings.endGroup();
}
...
void gl3dAxesView::onUpdateAxes()
{
    ...
    m_WindDir    = windDirection(s_Alpha, s_Beta);
    m_WindSide   = windSide(s_Alpha, s_Beta);
    m_WindNormal = windNormal(s_Alpha, s_Beta);
