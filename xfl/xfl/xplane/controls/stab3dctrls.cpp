...
{
    QString strange;
    strange   = QString::asprintf("x  = %9.5f ", m_ModeState[0] * Units::mtoUnit()) + Units::lengthUnitLabel() + EOLCHAR;
    strange  += QString::asprintf("y  = %9.5f ", m_ModeState[1] * Units::mtoUnit()) + Units::lengthUnitLabel() + EOLCHAR;
    strange  += QString::asprintf("z  = %9.5f ", m_ModeState[2] * Units::mtoUnit()) + Units::lengthUnitLabel() + EOLCHAR;
