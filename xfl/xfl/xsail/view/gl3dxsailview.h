...
class gl3dXSailView : public gl3dXflView
{
    ...
    public:
        ...
        void makeVisiblePanel3List(Boat const *pBoat, const BoatPolar *pBtPolar, QVector<Panel3> &panel3list);
        ...
        void setLiveVortons(QVector<QVector<Vorton>> const &vortons);
    ...
    private:
        ...
        bool glMakeStreamLines(QVector<Panel3> const &panel3list, const Boat *pBoat, BoatOpp const *pBtOpp);
    ...
    private:
        ...
        P3UniAnalysis *m_pP3UniAnalysis_;
        P3LinAnalysis *m_pP3LinAnalysis_;
