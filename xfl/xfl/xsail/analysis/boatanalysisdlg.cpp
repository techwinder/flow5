...
BoatTask* BoatAnalysisDlg::analyze(Boat *pBoat, BoatPolar *pBoatPolar, QVector<double> const &opplist)
{
...
{
    QString strong = "Are you sure you want to cancel the analysis?";
    int resp = QMessageBox::question(this, "Question", strong,  QMessageBox::Yes | QMessageBox::No | QMessageBox::Cancel);
...
/*    if(m_bIsFinished)
    {
//        m_pWorkerTask->panelAnalysis()->cancelAnalysis(false);
        close();
    }*/
}
