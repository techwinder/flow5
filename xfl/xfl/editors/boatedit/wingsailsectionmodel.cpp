    ...
    switch(role)
    {
        case Qt::DisplayRole:
        {
            switch(col)
            {
                ...
                case 9:
                {
                    return xfl::distributionType(ws.zDistType());
                }
                case 10:
                {
                    return "...";
...
bool WingSailSectionModel::setData(const QModelIndex& index, const QVariant& value, int role)
{
    ...
    if(role==Qt::EditRole)
    {
        ...
        switch(index.column())
        {
            ...
            case 5:
            {
                pws.setFoilName(value.toString());
                break;
            }
            case 6:
            {
            ...
            case 7:
            {
                pws.setXPanelDistType(xfl::distributionType(value.toString()));
                break;
            }
            case 8:
            {
            ...
            case 9:
            {
                pws.setZPanelDistType(xfl::distributionType(value.toString()));
                break;
            }
            default:
                return false;
