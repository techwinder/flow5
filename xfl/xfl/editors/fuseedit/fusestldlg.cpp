                    ...
                    QVBoxLayout *pMeshLayout = new QVBoxLayout;
                    {
                        QGroupBox *pSplitTriangleBox = new QGroupBox("Split mesh panels");
                        {
                            QGridLayout *pSplitLayout = new QGridLayout;
                            {
                                ...
                                QLabel *pLabUnit = new QLabel(Units::lengthUnitLabel());
...
void FuseStlDlg::onSplitMeshPanels()
{
    ...
    strange.clear();
    mesh.makeNodeArrayFromPanels(firstindex, strange, QString());
    updateOutput(strange+"\n");
...
{
    QString strange;
    m_pFuseStl->makeDefaultTriMesh(strange, QString());
    updateOutput(strange+"\n");
    m_pglFuseView->resetPanels();
    m_pglFuseView->update();
    updateProperties();
...
void FuseStlDlg::updateProperties(bool)
{
    ...
    m_pFuseStl->computeSurfaceProperties(log, QString());
