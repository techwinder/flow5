...
QVariant WingSectionModel::data(const QModelIndex &index, int role) const
{
    ...
    if(row<0 || row>=m_pWing->sectionCount()) return QVariant();// you never know
    ...
    switch(role)
    {
        case Qt::DisplayRole:
        {
            switch(col)
            {
                ...
                case 5:
                {
                    if(m_bRightSide) return ws.rightFoilName();
                    else             return ws.leftFoilName();
                }
                case 6:
                {
                    return ws.nXPanels();
                ...
                case 7:
                {
                    return xfl::distributionType(ws.xDistType());
                }
                case 8:
                {
                    return ws.nYPanels();
                ...
                case 9:
                {
                    return xfl::distributionType(ws.yDistType());
                }
                case 10:
                {
                    return "...";
    ...
    if(role==Qt::EditRole)
    {
        ...
        switch(index.column())
        {
            ...
            case 5:
            {
                ...
                {
                    if(m_bRightSide) pws->setRightFoilName(value.toString());
                    else             pws->setLeftFoilName(value.toString());
                }
                else
                {
                    pws->setRightFoilName(value.toString());
                    pws->setLeftFoilName(value.toString());
                }
                break;
            }
            case 6:
            {
                int nx = value.toInt();
                for(int iws=0; iws<m_pWing->sectionCount(); iws++)
                {
...
//                updateData();
            ...
            case 7:
            {
                pws->m_XPanelDist = xfl::distributionType(value.toString());
                break;
            }
            case 8:
            {
            ...
            case 9:
            {
                pws->m_YPanelDist = xfl::distributionType(value.toString());
                break;
            }
            default:
                return false;
