        ...
        case Qt::DisplayRole:
        {
            if(index.row()<m_pPlane->nWings())
            {
                switch(col)
                {
                    case 0:
                    {
                        return WingXfl::type(m_pPlane->wing(row)->type());
                    }
                    case 1:
                    {
                        return m_pPlane->wing(row)->name();
                    }
                    case 2:
                    {
            ...
            else if(row>=m_pPlane->nWings() && m_pPlane->hasFuse())
            {
                ...
                switch(col)
                {
                    ...
                    case 1:
                    {
                        return m_pPlane->fuse(ifuse)->name();
                    }
                    case 2:
                    {
    ...
    if(role==Qt::EditRole)
    {
        if(index.row()<m_pPlane->nWings())
        {
            switch(index.column())
            {
                case 0:
                {
                    if(m_pPlane->wing(index.row())->type() != WingXfl::type(value.toString()))
                    {
                        m_pPlane->wing(index.row())->setWingType(WingXfl::type(value.toString()));
                        bChanged = true;
                    }
                    break;
                }
                case 1:
                {
                    ...
                    {
                        m_pPlane->wing(index.row())->setPartName(value.toString().trimmed());
        ...
        else if(index.row()>=m_pPlane->nWings() && m_pPlane->hasFuse())
        {
            ...
            switch(index.column())
            {
                ...
                case 1:
                {
                    ...
                    {
                        m_pPlane->fuse(ifuse)->setPartName(value.toString().trimmed());
                        bChanged = true;
                    }
                    break;
                }
