...
void T6PolarDlg::fillOppRangePage()
{
    ...
    m_pOppRangeControlModel->setData(ind, Units::speedUnitLabel());
...
void T6PolarDlg::initPolar3dDlg(Plane const *pPlane, WPolar const *pWPolar)
{
...
void T6PolarDlg::readAngleRangeData()
{
    ...
    for(int iw=0; iw<pPlaneXfl->nWings(); iw++)
    {
        ...
        s_WPolar.m_AngleRange.back().push_back({m_pAngleControlModel->index(iCtrl, 0, QModelIndex()).data().toString(),
...
void T6PolarDlg::readOperatingData()
{
    ...
    s_WPolar.m_OperatingRange[0].setName(strange);
    ...
    s_WPolar.m_OperatingRange[1].setName(strange);
    ...
    s_WPolar.m_OperatingRange[2].setName(strange);
    ...
    s_WPolar.m_OperatingRange[3].setName(strange);
...
void T6PolarDlg::readInertiaData()
{
    ...
    s_WPolar.m_InertiaRange[0].setName(strange);
    ...
    s_WPolar.m_InertiaRange[1].setName(strange);
    ...
    s_WPolar.m_InertiaRange[2].setName(strange);
