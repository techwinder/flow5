...
class FL5LIB_EXPORT TriMesh : public XflMesh
{
    public:
        ...
        void makeConnectionsFromNodeIndexes(int i0, int n0, bool bConnectFlapPanels);
        void makeConnectionsFromNodePositions(bool bConnectTE, bool bMultiThread=true);
        void makeConnectionsFromNodePositions(int iStart, int nTotal, double MERGEDISTANCE);
