...
namespace gl
{
    ...
    void glMakeShellOutline(const NCollection_List<TopoDS_Shape> &shapes, const Vector3d &position, QOpenGLBuffer &vbo, int nWireRes=30);
    void glMakeEdges(TopoDS_Shape const &Shape, QOpenGLBuffer &vboEdges, QVector<Vector3d> &labelpoints);
    void glMakeEdges(NCollection_List<TopoDS_Shape> const &theEdges, const Vector3d &T, QOpenGLBuffer &vboEdges, QVector<Vector3d> &labelpoints);
