...
namespace GRAPH
{
    enum enumGraphType {BLGRAPH, OPPGRAPH, POLARGRAPH, POPPGRAPH, WPOLARGRAPH, STABPOLARGRAPH, STABTIMEGRAPH, CPGRAPH, INVERSEGRAPH, OTHERGRAPH};
    enum enumAutoScale {RESETTING, EXPANDING};
}
